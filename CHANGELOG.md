...
[Unreleased]: https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/compare/1.4.5...main
...
-   **Fix issue with related product for configured product in wishlist**  
    ...
    Many thanks to Nata Bratchykova (Perspective) for the contribution!
...
[1.2.7]: https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/compare/1.2.6...1.2.7
...
-   **Fix: Mobile Safari iOS double click required to start swatch selection**
    ...
    For more information, please refer to [merge request #942](https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/merge_requests/942).

-   **Allow adding additional links to header customer menu**

    Previously, it was not possible to add additional links to the customer-menu.phtml template without overriding the template.

    For more information please refer to the 1.2.7 upgrade notes or [issue #730](https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/issues/730).
...
-   **Hide view/reorder links for received async orders**
    ...
    For more information, please refer to [merge request #947](https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/merge_requests/947).
...
-   **Update version constraint for hyva-themes/magento2-reset-theme to 1.1.5**
    ...
    For more information please refer to [merge request #894](https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/merge_requests/894).
...
-   **Improve product option value check before setting**
    ...
    Under some conditions it previously was possible to set invalid product option values,
    for example when configuring an unconfigured product from the wishlist, which in turn led to option dropdowns being empty.
...
> The default cart page has been replaced with a Server-Side-Rendered version using PHP and AlpineJS, if you're upgrading and want to keep the GraphQL cart you need to install the GraphQL cart separately. 
> You should be able to keep using the GraphQL cart without further customizations and we will keep supporting both versions of the cart.
>
> If you're upgrading from <1.1.15 please check the [documentation page on upgrading](https://docs.hyva.io/hyva-themes/upgrading/upgrading-to-1-1-15.html).
> Any additional information and known bugs/issues to this release will be documented there.
...
-   **Bugfix: Escape product review gql mutation payload values**
    ...
    More information about this backward compatible change can be found in the [commit ff9095](https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/commit/ff9095ed535a64c8861de82400a14e000adf102a)
